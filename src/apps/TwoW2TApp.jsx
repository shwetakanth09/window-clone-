...
const Desc = styled.p` color: #555; font-size: 13px; margin: 0 0 16px; `;
...
export default function TwoW2TApp({ onClose }) {
  return (
    <Overlay onClick={e => { if (e.target === e.currentTarget) onClose(); }}>
      <WinBox onClick={e => e.stopPropagation()}>
        <TitleBar>
          <Title>2️⃣ 2Writers2Tiles</Title>
          <CloseBtn onClick={onClose}>✕</CloseBtn>
        </TitleBar>
        <Body>
          <GameTitle>2Writers2Tiles</GameTitle>
          <Desc>my virtual sandbox - infinite multiplayer sandbox over 2d canvas</Desc>
          <PlayBtn href="https://2w2t.org/" target="_blank" rel="noopener noreferrer">
            ▶ Play
          </PlayBtn>
        </Body>
      </WinBox>
