...
const GameTitle = styled.h2` color: #000080; margin: 0 0 16px; font-size: 18px; `;
...
export default function OoBioApp({ onClose }) {
  return (
    <Overlay onClick={e => { if (e.target === e.currentTarget) onClose(); }}>
      <WinBox onClick={e => e.stopPropagation()}>
        ...
        <Body>
          <GameTitle>Oo.bio Contributors</GameTitle>
          <VisitBtn href="https://oo.bio/contributors" target="_blank" rel="noopener noreferrer">
            ▶ Visit Oo.bio
          </VisitBtn>
        </Body>
      </WinBox>
