...
const Card = styled.div`
  ...
  border-bottom-color: #808080; padding: 20px;
`;
const GameTitle = styled.h2` color: #1b2838; margin: 0 0 8px; font-size: 18px; `;
const Desc = styled.p` color: #555; font-size: 12px; margin: 0 0 16px; `;
...
export default function SteamApp({ onClose }) {
  return (
    <Overlay onClick={e => { if (e.target === e.currentTarget) onClose(); }}>
      <WinBox onClick={e => e.stopPropagation()}>
        ...
        <Body>
          <Card>
            <GameTitle>🎮 Steam Profile</GameTitle>
            <Desc>Check out my Steam profile and see what I've been playing.</Desc>
            <PlayBtn href="https://steamcommunity.com/id/xqyet/" target="_blank" rel="noopener noreferrer">
              ▶ View Steam Profile
            </PlayBtn>
          </Card>
        </Body>
