...
export default function MotoX3MGame({ onClose }) {
  return (
    <Overlay onClick={e => { if (e.target === e.currentTarget) onClose(); }}>
      <WinBox onClick={e => e.stopPropagation()}>
        <TitleBar>
          <Title>🏍️ Moto X3M</Title>
          <CloseBtn onClick={onClose}>✕</CloseBtn>
        </TitleBar>
        <Body>
          <GameTitle>🏍️ Moto X3M</GameTitle>
          <Message>Game loading from external source...</Message>
          <PlayBtn href="https://fascinating-sundae-33fa9d.netlify.app/projects/moto-x3m/" target="_blank" rel="noopener noreferrer">
            ▶ Play in new tab
          </PlayBtn>
        </Body>
      </WinBox>
