...
const GameTitle = styled.h2` color: #000080; margin: 0 0 8px; font-size: 18px; `;
...
export default function HedgeCApp({ onClose }) {
  return (
    <Overlay onClick={e => { if (e.target === e.currentTarget) onClose(); }}>
      <WinBox onClick={e => e.stopPropagation()}>
        <TitleBar>
          <Title>📦 HedgeCrates</Title>
          <CloseBtn onClick={onClose}>✕</CloseBtn>
        </TitleBar>
        <Body>
          <GameTitle>HedgeCrates</GameTitle>
          <Desc>contributing developer to bauix's bio page service</Desc>
          <VisitBtn href="https://hedgecrates.com/" target="_blank" rel="noopener noreferrer">
            ▶ Visit HedgeCrates
          </VisitBtn>
        </Body>
      </WinBox>
