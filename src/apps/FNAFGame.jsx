...
const GameTitle = styled.h2` color: #000080; margin: 0 0 16px; font-size: 20px; `;
...
export default function FNAFGame({ onClose }) {
  return (
    <Overlay onClick={e => { if (e.target === e.currentTarget) onClose(); }}>
      <WinBox onClick={e => e.stopPropagation()}>
        ...
        <Body>
          <GameTitle>Five Nights at Freddy's 2</GameTitle>
          <PlayBtn href="https://fascinating-sundae-33fa9d.netlify.app/projects/fnaf-2/" target="_blank" rel="noopener noreferrer">
            ▶ Play in new tab
          </PlayBtn>
        </Body>
      </WinBox>
