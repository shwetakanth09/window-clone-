...
export default function SolitaireGame({ onClose }) {
  return (
    <Overlay onClick={e => { if (e.target === e.currentTarget) onClose(); }}>
      <WinBox onClick={e => e.stopPropagation()}>
        ...
        <Body>
          <GameTitle>🃏 Solitaire</GameTitle>
          <PlayBtn href="https://fascinating-sundae-33fa9d.netlify.app/projects/solitaire/" target="_blank" rel="noopener noreferrer">
            ▶ Play in new tab
          </PlayBtn>
        </Body>
      </WinBox>
